...
*/
   ...
   /*      b.longitud,
    ...
    /*CONTROL PARA ALGUNOS BLOCKS MULTIPOLIGNOS QUE TIENEN SHAPES DIMINUTOS   394996  3614502*/
    /* AND ST_AsText(st_centroid(b.shape_wkt)) NOT LIKE '%Infinity%' */
    AND  IS_FINITE(st_y( st_centroid(b.shape_wkt))) = TRUE