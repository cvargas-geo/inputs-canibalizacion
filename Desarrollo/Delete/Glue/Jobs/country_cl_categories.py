...
AmazonS3_node1649953615613 = glueContext.getSink(
    path="s3://georesearch-datalake/demo_datalake/raw/mastergeo_countries_customer_geolab_cvargas_country_cl_categories/",
    connection_type="s3",
...
AmazonS3_node1649953615613.setCatalogInfo(
    catalogDatabase="qa_migracion_postgres", catalogTableName="country_cl_categories"
)
